...
namespace DMCIT.Infrastructure.Migrations
{
    ...
    [Migration("20191119084820_change some column name")]
    partial class changesomecolumnname
    {
            ...
            modelBuilder.Entity("DMCIT.Core.Entities.Messaging.MessageServiceProvider", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddressLabel = "Viettel SMS Brandname", AddressRegex = "(84)+([0-9]{9})\\b", Code = "viettel", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 776, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 776, DateTimeKind.Local), Module = "DMCIT.Infrastructure.Providers.Test", Name = "Dịch vụ nhắn tin thương hiệu của Viettel" },
                        new { Id = 2, AddressLabel = "Netco SMS", AddressRegex = "(09|01[2|6|8|9])+([0-9]{8})\\b", Code = "netco", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 776, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 776, DateTimeKind.Local), Module = "DMCIT.Infrastructure.Providers.Test", Name = "Dịch vụ nhắn tin giá rẻ Netco" },
                        new { Id = 3, AddressLabel = "Zalo", AddressRegex = "(.*?)", Code = "zalo", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 776, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 776, DateTimeKind.Local), Module = "DMCIT.Infrastructure.Providers.Test", Name = "Dịch vụ nhắn tin qua Zalo" }
                    );
                });
            ...
            modelBuilder.Entity("DMCIT.Core.Entities.Sales.Distributor", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "DT", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Đồng Tháp" },
                        new { Id = 2, Code = "CT", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Cần Thơ" },
                        new { Id = 3, Code = "AG", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh An Giang" },
                        new { Id = 4, Code = "TP", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Hồ Chí Minh" },
                        new { Id = 5, Code = "MD", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Miền Đông" },
                        new { Id = 6, Code = "TN", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Tây Nguyên" },
                        new { Id = 7, Code = "DN", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Đà Nẵng" },
                        new { Id = 8, Code = "VI", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Vinh" },
                        new { Id = 9, Code = "TH", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Thái Nguyên" },
                        new { Id = 10, Code = "HN", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Hà Nội" },
                        new { Id = 11, Code = "HD", DateCreated = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), DateEffective = new DateTime(2019, 11, 19, 15, 48, 19, 773, DateTimeKind.Local), Name = "Chi nhánh Hải Dương" }
                    );
                });
